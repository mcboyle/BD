...
class TransportMixin:
    ...
    def _do_direct_http_download(
        ...
        try:
            ...
            with owning_stream(
                httpx.Client(proxy=proxy_url, transport=guarded_transport(PINNED)),
    ...
    def _do_probe_fetch(self,page_url,page,ctx,dl,best,res_lbl,suggested):
        ...
        try:
            from bulk_downloader.ssrf_transport import guarded_transport, owning_stream, PINNED
            with owning_stream(httpx.Client(proxy=proxy_url, transport=guarded_transport(PINNED)),
        ...
        try:
            if cffi_streamer is not None:
                ...
                resp_ctx = owning_stream(
                    httpx.Client(transport=guarded_transport(PINNED), **client_kwargs),
    ...
    def _probe_size(self, file_url, page_url, ctx):
        ...
        try:
            ...
            try:
                ...
                with httpx.Client(transport=guarded_transport(PINNED), **kw) as client:
            ...
            try:
                ...
                try:
                    if _cffi:
                        ...
                        from bulk_downloader.ssrf_transport import guarded_transport, owning_stream, PINNED
                        resp_ctx = owning_stream(
                            httpx.Client(transport=guarded_transport(PINNED), **kw),
