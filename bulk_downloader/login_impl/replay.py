...
def write_login_evidence(page, config, final_url, tag):
    ...
    try:
        ...
        try:
            ...
            sys.stderr.write(f"  login: evidence screenshot unavailable: {e}\n")
        return str(path)
    except Exception as e:
...
def keep_pre_submit_screenshot(page, config):
    ...
    try:
        ...
        sys.stderr.write(f"  login: pre-submit screenshot unavailable: {e}\n")
        return None
...
def _read_login_surface(page):
    ...
    try:
        ...
        sys.stderr.write(f"  login: post-submit surface unreadable: {e}\n")
        return None
