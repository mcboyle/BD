...
def get_streaming_client_metadata() -> dict[str, Any]:
    """Metadata describing modernized async event streaming capabilities."""
    return {
        "aiokafka_capable": True,
        "faststream_adapter": True,
...
class _FallbackAIOKafkaProducer:
    """Coroutine-native fallback producer when aiokafka is not installed."""
