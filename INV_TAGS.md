...
- `bulk_downloader/runner.py:3011` — `_sk.pause_site_keepers(self.site_id)  # INV-001`
- `bulk_downloader/runner.py:3073` — `_sk.pause_site_keepers(self.site_id)  # INV-001`
...
- `bulk_downloader/session_keeper.py:1036` — `def pause_site_keepers(site_id: str) -> int:  # INV-001`

## INV-002 — live source tags

- `bulk_downloader/dev_suite/audit_security.py:146` — `_DISPATCH_CHAIN = [  # INV-002`
- `bulk_downloader/runner.py:3816` — `def _process_one(self,browser,url,persistent_ctx=None):  # INV-002`
...
- `bulk_downloader/secrets_store.py:1812` — `def resolve_password(value: str | None) -> str | None:  # INV-006`
