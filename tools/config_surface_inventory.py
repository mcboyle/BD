...
_STRING_FIELD_META = {
    ...
    "dismiss_selectors": ("acquisition", "medium", "Selectors to dismiss overlays/popups", "selector list", "Site editor → Selectors"),
...
_RELATED = {
    ...
    "dismiss_selectors": ["dl_selector", "trigger_selector"],
