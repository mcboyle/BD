...
def test_template_start_and_teardown_are_bound_to_the_named_instance(
    ...
    stopped = subprocess.run(
        [str(SERVICE_INSTALLER), "stop", "run-a"], cwd=REPO, env=env,
