...
def test_1240_every_pinned_spec_exists_and_the_pin_is_nonzero():
...
def test_1240_supervisor_limits_survive_an_untouched_apply():
...
def test_1240_supervisor_fields_are_seeded_from_get():
...
def test_1240_supervisor_section_still_mounts_and_is_confirm_gated():
