...
_DECLARED = {
    ...
    # @1206 determinism review. These are the other row-212 contracts whose
    # subjects do not become safe merely because a diff-derived local band can
    # find them: 1132 owns registration-failure process restoration, 1106 owns
    # the preflight UNKNOWN grade for an unreadable jobs registry, and the
    # provider surface lock owns the collection-order seam changed by this cut.
