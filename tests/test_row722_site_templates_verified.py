...
_PROOF_VALUES = {
    ...
    # Row 722 spread (2026-09-15): values PUT on :5555 and used by the PASS runs.
    "pegasproductions": {
    ...
    "nubiles-porn": {"login_url": "https://nubiles-porn.com/login"},
    "pornone": {
...
_VERIFIED = [
    ...
    # Row 722 spread (2026-09-15, bd-worker-A20-A): the sheet sites that completed
    # login -> one scene file on :5555 (evidence .live-proof/SPREAD-RUNNER-3.md).
    ("pegasproductions", "pegasproductions", "pegasproductions.com"),
    ("reptyle", "reptyle_teamskeet", "auth.reptyle.com"),
    ("africancasting", "africancasting", "members.africancasting.com"),
    ("bang", "bang_originals", "www.bang.com"),
    ("dorcelclub", "dorcelclub", "www.account-dorcel.com"),
    ("xempire", "xempire", "www.xempire.com"),
    ("nubiles-porn", "nubiles_network", "nubiles-porn.com"),
    ("pornone", "pornone", "pornone.com"),
]
...
def test_every_verified_template_id_is_present_exactly_once():
    ...
    assert len(_TEMPLATE_IDS) == 23, _TEMPLATE_IDS
