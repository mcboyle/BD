...
STAGE=/home/claude/release_147
OUT=/mnt/user-data/outputs/BulkDownloader_v3_66_147.zip
...
echo "--- new-in-147 detection-safety additions ---"
grep -E "selector_lint|test_v3_66_147" /tmp/add.txt
