...
STAGE=/home/claude/release_146
OUT=/mnt/user-data/outputs/BulkDownloader_v3_66_146.zip
...
echo "--- new-in-146 detection-safety additions ---"
grep -E "selector_lint|test_v3_66_146" /tmp/add.txt
