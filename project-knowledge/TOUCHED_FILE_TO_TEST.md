...
| `bulk_downloader/app_template.py` (SSRF route) | `test_c1_ssrf_and_fileread`, `test_v3_66_24_phase4_ssrf_hardening` |
| `bulk_downloader/provider_resolve_impl/_common.py` (SSRF guard and return types) | `test_c1_ssrf_and_fileread`, `test_v3_66_24_phase4_ssrf_hardening` |
