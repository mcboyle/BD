...
- internal import edges: **1883**
- tools: 234 · with internal edge: 134 · with tool→package edge: 74
- blueprints: 162 · config stores: 5

## Most-imported modules (coupling hotspots)

- `bulk_downloader/db.py`: 119
- `bulk_downloader/global_config.py`: 56
- `bulk_downloader/constants.py`: 33
- `bulk_downloader/ssrf_transport.py`: 29
...
- `bulk_downloader/capture_artifact_redact.py`: 15
...
- **envfile_editor** (`app_envfile_editor.py`) — routes 2, providers 2
...
- **health** (`app_health.py`) — routes 3, providers 5
...
- **knowledge** (`app_knowledge.py`) — routes 4, providers 2
...
- **service_mesh** (`service_mesh.py`) — routes 1, providers 1
...
- **template** (`app_template.py`) — routes 5, providers 5
